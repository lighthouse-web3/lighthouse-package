...
const deriveKey = async (sourceKey: any, keyUsage: any, keyDerivationParams: any) =>
  crypto.subtle.deriveKey(keyDerivationParams, sourceKey, { name: 'AES-GCM', length: 256 }, false, keyUsage);
