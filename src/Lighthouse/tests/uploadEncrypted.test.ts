...
describe('UploadEncrypted', () => {
  test('deploy Encrypted Main Case File', async () => {
    ...
    const signer = new ethers.Wallet('0x8488d2c632da07a93647d7cf701ab6728a884467b1595f3c94007977a20b3539', provider);
    ...
    const deployResponse = (
      await lighthouse.uploadEncrypted(path, apiKey.data.apiKey, publicKey, signedMessageEncryption)
    ).data;
