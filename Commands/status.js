...
module.exports = {
  ...
  handler: async function (argv) {
    if (argv.help) {
      ...
      console.log();
      console.log(
        chalk.yellow("CID:") + Array(9).fill("\xa0").join("") + response[0]["content"]["cid"]
      );
      console.log(
        chalk.yellow("Name:") + Array(8).fill("\xa0").join("") + response[0]["content"]["name"]
      );
      console.log(
        chalk.yellow("Size:") + Array(8).fill("\xa0").join("") + bytesToSize(response[0]["content"]["size"])
      );
      console.log(
        chalk.yellow("Replication:") + Array(1).fill("\xa0").join("") + response[0]["content"]["replication"]
      );
      console.log();
